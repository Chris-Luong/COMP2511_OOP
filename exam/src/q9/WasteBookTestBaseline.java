...
public class WasteBookTestBaseline {
    ...
    public static void testBasic() {
        ...
        assertEquals(0, controller.getAmountOfFriends("Nathan"));
        assertEquals(0, controller.getAmountOfFriends("Evanlyn"));
        assertEquals(1, controller.getAmountOfFriends("Hamish"));
        assertEquals(1, controller.getAmountOfFriends("Amelia"));
